...
8. When the user confirms filling (e.g. "yes", "do it", "go ahead") without providing specific values, fill immediately with realistic example data. Do not re-ask for the same fields.
